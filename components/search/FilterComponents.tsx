                ...
                {categories.map((category, index) => (
                    <label className="text-lg font-normal" key={category}>
                        <div className="relative flex flex-row items-center gap-2">
                            <input
                                type="checkbox"
                                className="bg-primary-foreground h-6 w-6 appearance-none rounded-md border-[1px] border-border-muted checked:bg-accent"
                ...
                <div>
                    ...
                    <div className="flex flex-row items-center gap-2">
                        <DatePicker
                            ...
                            className="w-44 appearance-none rounded-lg border-[1px] border-border-muted px-4 py-2"
                        />
                    </div>
                </div>
            </div>
        ...
        <div className="relative flex flex-col">
            ...
            <div className="relative">
                <select
                    ...
                    className="text-regular block h-full w-full appearance-none overflow-ellipsis rounded-lg border-[1px] border-border-muted px-4 py-2 pr-12"
                >
                ...
                <div className="absolute right-1 top-[14px] h-8 w-8 text-muted">
                    <FaChevronDown />
                </div>
            </div>
            <div className="mt-4 border-2 border-t border-border"></div>
    ...
    return (
        <div className="relative flex flex-col">
            <div className="relative">
                ...
                <div className="pointer-events-none absolute right-1 top-[14px] h-8 w-8 text-muted">
                    <FaChevronDown />
                </div>
            </div>
        </div>
