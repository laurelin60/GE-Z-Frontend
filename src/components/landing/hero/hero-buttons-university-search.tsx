...
interface HeroButtonsUniversitySearchProps {
    defaultUniversity: University | null;
}

export function HeroButtonsUniversitySearch({
    defaultUniversity,
}: HeroButtonsUniversitySearchProps) {
    ...
    return (
        <div className="flex w-full shrink-0 flex-col gap-0 sm:flex-row lg:w-fit">
            ...
            <div
                ...
                onClick={clickSearchDisabled ? undefined : handleClickSearch}
            >
                <Button
                    size="lg"
